...
const CollectorRegistration = () => {
  ...
  return (
    <PageLayout containerClassName="px-4 md:container md:mx-auto">
      {/* Hero Section - Made responsive */}
      <div className="bg-gradient-to-r from-waste-green-500/90 to-waste-blue-500/90 text-white py-8 md:py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Join Our Collector Network</h1>
      ...
      {/* Main Content - Updated layout for mobile */}
          ...
          <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6 md:mb-8">
                <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Application Form</h2>
                ...
                <div className="flex items-center min-w-max py-2 px-1">
                  {formSteps.map((step, index) => (
                    ...
                    >
                      ...
                      >
                        <div 
                          className={`w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center mb-1 ${
                            index < currentStep 
                        ...
                        <span className="text-xs md:text-sm text-center w-16 md:w-24">
                          {step.title}
                        </span>
                      </div>
                      {index < formSteps.length - 1 && (
                        <div 
                          className={`w-6 md:w-16 h-0.5 ${
              ...
              {isSubmitted ? (
                <Card className="border-waste-green-500">
                  <CardContent className="pt-6 flex flex-col items-center text-center">
                    <div className="bg-waste-green-100 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mb-4 md:mb-6">
                      <CheckCircle className="h-8 w-8 md:h-10 md:w-10 text-waste-green-500" />
                    </div>
                    <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Application Submitted!</h3>
                    <p className="text-gray-600 max-w-md mb-4 md:mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3 md:gap-4">
                      <Button 
                        onClick={goToSignIn}
                        className="bg-waste-green-500 hover:bg-waste-green-600 w-full sm:w-auto"
                      >
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 md:space-y-8">
                    <Card className="p-4 md:p-6">
                      ...
                      <div className="flex flex-wrap justify-between mt-6 md:mt-8 pt-4 border-t">
                        <Button
                          type="button"
                          variant="outline"
                          onClick={prevStep}
              ...
              <div className="space-y-6 md:space-y-8 lg:sticky lg:top-24">
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="text-lg md:text-xl font-semibold mb-4">Why Join Us?</h3>
                    <ul className="space-y-3 md:space-y-4">
                      <li className="flex items-start gap-3">
                        <div className="bg-waste-green-100 p-2 rounded-full mt-0.5 shrink-0">
                          <DollarSign className="h-4 w-4 md:h-5 md:w-5 text-waste-green-500" />
                        </div>
                        <div>
                          <p className="font-medium">Competitive Earnings</p>
                          <p className="text-gray-600 text-sm md:text-base">Earn up to $25-35/hour including tips</p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="bg-waste-blue-100 p-2 rounded-full mt-0.5 shrink-0">
                          <Clock className="h-4 w-4 md:h-5 md:w-5 text-waste-blue-500" />
                        </div>
                        <div>
                          <p className="font-medium">Flexible Schedule</p>
                          <p className="text-gray-600 text-sm md:text-base">Choose when you work to fit your lifestyle</p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="bg-waste-green-100 p-2 rounded-full mt-0.5 shrink-0">
                          <Calendar className="h-4 w-4 md:h-5 md:w-5 text-waste-green-500" />
                        </div>
                        <div>
                          <p className="font-medium">Steady Work</p>
                          <p className="text-gray-600 text-sm md:text-base">Regular collection opportunities all year</p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="bg-waste-blue-100 p-2 rounded-full mt-0.5 shrink-0">
                          <Shield className="h-4 w-4 md:h-5 md:w-5 text-waste-blue-500" />
                        </div>
                        <div>
                          <p className="font-medium">Insurance Coverage</p>
                          <p className="text-gray-600 text-sm md:text-base">Liability insurance provided while on duty</p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="bg-waste-green-100 p-2 rounded-full mt-0.5 shrink-0">
                          <Users className="h-4 w-4 md:h-5 md:w-5 text-waste-green-500" />
                        </div>
                        <div>
                          <p className="font-medium">Supportive Community</p>
                          <p className="text-gray-600 text-sm md:text-base">Join a network of professional collectors</p>
                        </div>
                      </li>
                    </ul>
                  </CardContent>
                ...
                {currentStep === 4 && (
                  <Card className="hidden md:block"> {/* Hide on small screens to save space */}
                    <CardContent className="pt-6">
                      <h3 className="text-xl font-semibold mb-4">Application Process</h3>
                      <ol className="space-y-3 md:space-y-4 relative border-l border-gray-200 pl-6 ml-2">
      ...
      {/* Testimonials - More responsive */}
      <div className="py-8 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Hear From Our Collectors</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card className="p-6 md:p-8">
              <div className="flex items-center mb-4 md:mb-6">
                <div className="bg-waste-green-100 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mr-4 shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-waste-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-base md:text-lg font-bold">James Reynolds</h3>
                  <p className="text-gray-500 text-sm md:text-base">Collector since 2023</p>
                </div>
              </div>
            ...
            <Card className="p-6 md:p-8">
              <div className="flex items-center mb-4 md:mb-6">
                <div className="bg-waste-blue-100 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mr-4 shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-waste-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-base md:text-lg font-bold">Maria Sanchez</h3>
                  <p className="text-gray-500 text-sm md:text-base">Collector since 2022</p>
                </div>
              </div>
              <p className="text-gray-700 mb-4 text-sm md:text-base">
            ...
            <Card className="p-6 md:p-8">
              <div className="flex items-center mb-4 md:mb-6">
                ...
                <div>
                  <h3 className="text-base md:text-lg font-bold">David Chen</h3>
                  <p className="text-gray-500 text-sm md:text-base">Collector since 2024</p>
                </div>
              </div>
              <p className="text-gray-700 mb-4 text-sm md:text-base">
      ...
      <div className="py-8 md:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto grid gap-4 md:gap-6">
            <Card className="p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-semibold mb-2">How often will I get paid?</h3>
            ...
            <Card className="p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-semibold mb-2">Do I need my own equipment?</h3>
              <p className="text-gray-700 text-sm md:text-base">
            ...
            <Card className="p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-semibold mb-2">How are pickup assignments determined?</h3>
              <p className="text-gray-700 text-sm md:text-base">
            ...
            <Card className="p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-semibold mb-2">Where do I take the collected waste?</h3>
              <p className="text-gray-700 text-sm md:text-base">
            ...
            <Card className="p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-semibold mb-2">What kind of support is available for collectors?</h3>
              <p className="text-gray-700 text-sm md:text-base">
      ...
      {/* CTA - Better padding and button layout for mobile */}
      <div className="bg-gradient-to-r from-waste-green-500/90 to-waste-blue-500/90 text-white py-8 md:py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-6">Ready to Join Our Team?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            <Button asChild size="lg" className="bg-white text-waste-green-500 hover:bg-gray-100 w-full sm:w-auto">
              <a href="#top">
                Apply Now
